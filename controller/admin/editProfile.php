...
<html>
	...
	<body>
		...
		<div class="title">Edite Profile</div>
	    <div class="updatearea">
			<form action="adminPage.php" method="POST" enctype="multipart/form-data" class="updateForm">
				...
				<input type="text" name="username" required autofocus placeholder="User Name" value=<?php echo $result['username'] ;?>><br>

				<input type="password" name="pwd" required autofocus placeholder="Password" value=<?php echo $result['pwd']; ?>><br>

		        <input type="email" name="email" required autofocus placeholder="E-mail" value=<?php echo $result['email']; ?>><br>

		        <div class="inputs">
		        	<label>Upload image : </label><input type="file" name="imgEdit" value="Upload image">
		        </div><br>
